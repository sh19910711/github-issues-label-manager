(function() {
  ...
  define(["underscore", "jquery", "backbone", "app/common", "app/repository", "com/backbone/backbone-fetch-cache"], function(_, $, Backbone, Common, Repository) {
    ...
    return Repositories = (function(_super) {
      ...
      Repositories.prototype.model = Repository.Models.Repository;
