...
e&&c.cache!==!1&&(c.cache||c.prefill)&&(c.expires!==!1&&(f=(new Date).getTime()+1e3*(c.expires||300)),b.fetchCache._cache[e]={expires:f,value:d},b.fetchCache.setLocalStorage())}function f(a){delete b.fetchCache._cache[a],b.fetchCache.setLocalStorage()}function g(){if(k&&b.fetchCache.localStorage)try{localStorage.setItem("backboneCache",JSON.stringify(b.fetchCache._cache))}catch(a){var c=a.code||a.number||a.message;if(22!==c)throw a;this._deleteCacheWithPriority()}}function h(){if(k&&b.fetchCache.localStorage){var a=localStorage.getItem("backboneCache")||"{}";b.fetchCache._cache=JSON.parse(a)}}function i(a){return window.setTimeout(a,0)}// Setup
